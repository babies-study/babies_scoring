...
##Parameters
free_play_file <- "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/lab_caregiving_behavior/raw_data/PCIRS_FreePlay_MASTER_20200319.xlsx"
```
...
```{r}
write_csv(fp_final_wf, "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/lab_caregiving_behavior/free_play_wf_20200319.csv")
```
