...
cesd_18mo_lg_file <- "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/survey_18month/raw_data/mo18_survey_lg_20200414.csv"
```
...
cesd_18 <-
  ...
  select(record_id, starts_with("cesd")) %>% 
...
```{r}
write_csv(cesd_wf, "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/CESD/cesd_wf_20200507.csv")
write_csv(cesd, "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/CESD/cesd_lf_20200507.csv")
```
