...
demo_mom_long_file <- "~/Desktop/lena_18mo_symptoms/Data/demo_long_preg_20190726.csv"
demo_baby_long_file <- "~/Desktop/lena_18mo_symptoms/Data/demo_long_nb_20190726.csv"
dob_cs_file <- "~/Desktop/lena_18mo_symptoms/Data/dob_cs_20190131.csv"
dob_long_file <- "~/Desktop/lena_18mo_symptoms/Data/dob_long_20190726.csv"
visit_date_cs_file <- "~/Desktop/lena_18mo_symptoms/Data/visit_date_cs_20190131.csv"
visit_date_long_6mo_file <- "~/Desktop/lena_18mo_symptoms/Data/visit_date_long_6mo_20190726.csv"
visit_dates_long_t1t2_file <- "~/Desktop/lena_18mo_symptoms/Data/long_t1t2_dates_20190726.csv"
t1s1_date_file <- "~/Desktop/lena_18mo_symptoms/Data/t1s1_date.csv"
...
read_csv(dob_long_file) %>% 
      ...
      mutate(
        ID = as.integer(ID),
        mom_dob = as.Date(mom_dob, "%m/%d/%y"),
        baby_dob = as.Date(baby_dob, "%m/%d/%y"),
        baby_due_date = as.Date(baby_due_date, "%m/%d/%y")
      )
...
dates <-
  ...
  mutate(
    ...
    weeks_gestation_preg_visit = (baby_conception_date %--% date_preg) / weeks(1)
  )
...
#join dates to other demographic stuff

demo <-
    dates %>% 
      select(ID, contains("age"), baby_dob, weeks_gestation_preg_visit)
...
write_csv(demo, "~/Desktop/lena_18mo_symptoms/Data/demographics_20190726.csv")
```
