...
#Parameters
sfp_care_file <- "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/lab_caregiving_behavior/raw_data/PCIRS_SFP_MASTER_20200319.xlsx"
...
```{r export data}
write_csv(sfp_care_wf, "~/Box/Mooddata_Coordinating/BABIES/Data/final_scored_data/lab_caregiving_behavior/PCIRS_sfp_wf_20200319.csv")
```
